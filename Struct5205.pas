...
const
  ...
  SetupVersion = '5.2.4'{$IFDEF UNICODE}+'-unicode'{$ENDIF}+'-dev';
...
const
  ...
  SetupID: TSetupID = 'Inno Setup Setup Data (5.2.5)'{$IFDEF UNICODE}+' (u)'{$ENDIF};
  UninstallLogID: array[Boolean] of TUninstallLogID =
    ('Inno Setup Uninstall Log (b)', 'Inno Setup Uninstall Log (b) 64-bit');
  MessagesHdrID: TMessagesHdrID = 'Inno Setup Messages ' + {$IFDEF UNICODE}'(5.2.5) (u)'{$ELSE}'(5.1.11)'{$ENDIF};
